...
* HU-011: Como arquitecto de software, quiero crear un diagrama de despliegue que represente la infraestructura del sistema distribuido, para documentar cómo se distribuyen y comunican los módulos del proyecto en los diferentes entornos de ejecución.
* HU-012: Como arquitecto de software, quiero crear un diagrama C4 que represente los niveles de arquitectura del sistema, para visualizar de forma clara la estructura, los componentes y sus interacciones dentro de la arquitectura distribuida del proyecto.
...
* HU-C17: Como diseñador de interfaz de usuario, quiero modificar la apariencia visual del sistema, para mejorar la experiencia del usuario, unificar el estilo entre los módulos y garantizar una presentación profesional y coherente del producto final.
...
* HU-230: Como arquitecto de software, quiero realizar la configuración básica del módulo Gateway, para definir las características del servicio y hacer que los otros servicios se registren en el módulo.
...
* HU-C18: Como arquitecto DevOps, quiero implementar Jenkins en el frontend, para automatizar el proceso de integración continua y despliegue continuo, garantizando la eficiencia, calidad y consistencia en las entregas del sistema.

### Sprint 12

* HU-C19: Como arquitecto DevOps, quiero implementar Jenkins en el módulo Student, para automatizar el proceso de integración continua y despliegue continuo, garantizando la eficiencia, calidad y consistencia en las entregas del sistema.
* HU-C20: Como arquitecto DevOps, quiero implementar Jenkins en el módulo Teacher, para automatizar el proceso de integración continua y despliegue continuo, garantizando la eficiencia, calidad y consistencia en las entregas del sistema.
* HU-C21: Como arquitecto DevOps, quiero implementar Jenkins en el módulo University, para automatizar el proceso de integración continua y despliegue continuo, garantizando la eficiencia, calidad y consistencia en las entregas del sistema.
* HU-C22: Como arquitecto DevOps, quiero implementar Jenkins en el módulo Eureka, para automatizar el proceso de integración continua y despliegue continuo, garantizando la eficiencia, calidad y consistencia en las entregas del sistema.
* HU-C23: Como arquitecto DevOps, quiero implementar Jenkins en el módulo Gateway, para automatizar el proceso de integración continua y despliegue continuo, garantizando la eficiencia, calidad y consistencia en las entregas del sistema.
* HU-C24: Como arquitecto DevOps, quiero implementar Jenkins en el módulo Auth, para automatizar el proceso de integración continua y despliegue continuo, garantizando la eficiencia, calidad y consistencia en las entregas del sistema.

### Sprint 13

* HU-C25: Como desarrollador backend, quiero implementar pruebas unitarias e integrarlas con SonarQube en el frontend, para analizar la calidad del código, mejorar la cobertura y garantizar que las funcionalidades cumplan con los estándares.
* HU-C26: Como desarrollador backend, quiero implementar pruebas unitarias e integrarlas con SonarQube en el módulo Eureka, para analizar la calidad del código, mejorar la cobertura y garantizar que las funcionalidades cumplan con los estándares.
* HU-C27: Como desarrollador backend, quiero implementar pruebas unitarias e integrarlas con SonarQube en el módulo Gateway, para analizar la calidad del código, mejorar la cobertura y garantizar que las funcionalidades cumplan con los estándares.
* HU-C28: Como desarrollador backend, quiero implementar pruebas unitarias e integrarlas con SonarQube en el módulo Auth, para analizar la calidad del código, mejorar la cobertura y garantizar que las funcionalidades cumplan con los estándares.
* HU-C29: Como desarrollador backend, quiero actualizar las pruebas unitarias del módulo Student y sincronizarlas con SonarQube, para asegurar que los análisis de calidad del código reflejen el estado del módulo y mantengan un nivel óptimo de cobertura.
* HU-C30: Como arquitecto del sistema, quiero desplegar los módulos del sistema en un entorno en la nube, para garantizar la disponibilidad, escalabilidad y accesibilidad del sistema desde cualquier ubicación.
